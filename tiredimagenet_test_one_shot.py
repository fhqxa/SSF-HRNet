...
parser.add_argument("-t","--test_episode", type = int, default = 1000)  # 1000
...
def main():
    ...
    _,metatest_folders = tg.tired_imagenet_folders()
    ...
    parent_relation_network_optim = torch.optim.Adam(parent_relation_network.parameters(),lr=LEARNING_RATE)
    parent_relation_network_scheduler = StepLR(parent_relation_network_optim,step_size=100000,gamma=0.5)
    fine_relation_network_optim = torch.optim.Adam(fine_relation_network.parameters(),lr=LEARNING_RATE)
    fine_relation_network_scheduler = StepLR(fine_relation_network_optim,step_size=100000,gamma=0.5)

    # #加载已训练模型
    if os.path.exists(str("/home/dj212/ZYQ/实验1/SSF-HRNET/test_result/tiredImageNet/5-way-1-shot/H_SCR_0.1C/tiredImageNet_feature_encoder_5way_1shot.pkl")):
        feature_encoder.load_state_dict(torch.load(str("/home/dj212/ZYQ/实验1/SSF-HRNET/test_result/tiredImageNet/5-way-1-shot/H_SCR_0.1C/tiredImageNet_feature_encoder_5way_1shot.pkl")))
        print("load feature encoder success")

    if os.path.exists(str("/home/dj212/ZYQ/实验1/SSF-HRNET/test_result/tiredImageNet/5-way-1-shot/H_SCR_0.1C/tiredImageNet_parent_relation_network_5way_1shot.pkl")):
        parent_relation_network.load_state_dict(torch.load(str("/home/dj212/ZYQ/实验1/SSF-HRNET/test_result/tiredImageNet/5-way-1-shot/H_SCR_0.1C/tiredImageNet_parent_relation_network_5way_1shot.pkl")))
        print("load parent relation network success")

    if os.path.exists(str("/home/dj212/ZYQ/实验1/SSF-HRNET/test_result/tiredImageNet/5-way-1-shot/H_SCR_0.1C/tiredImageNet_fine_relation_network_5way_1shot.pkl")):
        fine_relation_network.load_state_dict(torch.load(str("/home/dj212/ZYQ/实验1/SSF-HRNET/test_result/tiredImageNet/5-way-1-shot/H_SCR_0.1C/tiredImageNet_fine_relation_network_5way_1shot.pkl")))
        print("load fine relation network success")

    if os.path.exists(str("/home/dj212/ZYQ/实验1/SSF-HRNET/test_result/tiredImageNet/5-way-1-shot/H_SCR_0.1C/tiredImageNet_feature_encoder_optim_5way_1shot.pkl")):
        feature_encoder_optim.load_state_dict(torch.load(str("/home/dj212/ZYQ/实验1/SSF-HRNET/test_result/tiredImageNet/5-way-1-shot/H_SCR_0.1C/tiredImageNet_feature_encoder_optim_5way_1shot.pkl")))
        print("load feature encoder optim success")

    if os.path.exists(str("/home/dj212/ZYQ/实验1/SSF-HRNET/test_result/tiredImageNet/5-way-1-shot/H_SCR_0.1C/tiredImageNet_parent_relation_network_optim_5way_1shot.pkl")):
        parent_relation_network_optim.load_state_dict(torch.load(str("/home/dj212/ZYQ/实验1/SSF-HRNET/test_result/tiredImageNet/5-way-1-shot/H_SCR_0.1C/tiredImageNet_parent_relation_network_optim_5way_1shot.pkl")))
        print("load parent relation network optim success")

    if os.path.exists(str("/home/dj212/ZYQ/实验1/SSF-HRNET/test_result/tiredImageNet/5-way-1-shot/H_SCR_0.1C/tiredImageNet_fine_relation_network_optim_5way_1shot.pkl")):
        fine_relation_network_optim.load_state_dict(torch.load(str("/home/dj212/ZYQ/实验1/SSF-HRNET/test_result/tiredImageNet/5-way-1-shot/H_SCR_0.1C/tiredImageNet_fine_relation_network_optim_5way_1shot.pkl")))
    ...
    for episode in range(EPISODE):
            ...
            for test_episode in range(TEST_EPISODE):
                ...
                sample_features = feature_encoder(Variable(sample_images).cuda(GPU)).unsqueeze(0) # 5x64*5*5
                test_features = feature_encoder(Variable(test_images).cuda(GPU)) # 20x64*5*5
                ...
                relation_pairs = torch.cat((sample_features_ext,test_features_ext),2).view(-1,FEATURE_DIM*2,6,6)
                ...
                parents_relations = parent_relation_network(parent_relation_pairs).view(-1,test_parents_num)# 计算关系得分
